...
export const SearchCompanyEmployeesInputSchema = Type.Object(
  {
    company_uid: Type.String({
      description:
        'The Captain Data unique identifier for the company. Get this from search_companies or enrich_company first.',
...
export const searchCompanyEmployeesToolSchema = {
  description:
    'Search for employees of a specific company. Use this when you need to find people working at a particular organization. Perfect for identifying key contacts, decision-makers, or potential leads within target companies.',
