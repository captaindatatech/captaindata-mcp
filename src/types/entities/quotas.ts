...
export const GetQuotasResponseSchema = Type.Object({
  ...
  credits_left: Type.Optional(Type.Number({ 
    default: 0,
    description: 'Remaining credits' 
  })),
  credits_max: Type.Optional(Type.Integer({ 
    default: 0,
    description: 'Maximum credits allowed' 
  })),
  credits_used: Type.Optional(Type.Number({ 
    default: 0,
  ...
  current_month_start: Type.Optional(Type.Union([
    Type.String({ format: 'date-time' }),
    Type.Null()
  ], { description: 'Start of current billing period' })),
  current_month_end: Type.Optional(Type.Union([
    Type.String({ format: 'date-time' }),
    Type.Null()
...
export const getQuotasToolSchema = {
  description: "Get current workspace quota and billing information. Use this to check your remaining credits, usage statistics, and billing cycle dates. Helpful for monitoring API consumption and planning usage.",
