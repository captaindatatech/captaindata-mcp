...
export const FindPersonInputSchema = Type.Object(
  {
    ...
    company_name: Type.Optional(
      Type.String({
        description:
          'The company name to help narrow down the search results. Highly recommended for common names.',
...
export const SearchPeopleInputSchema = Type.Object(
  {
    query: Type.String({
      description:
        'A Sales Navigator People search compliant query param. Please copy the entire value of the query parameter from your Sales Navigator search URL (everything after ?query=) and paste it here.',
...
export const EnrichPersonInputSchema = Type.Object(
  {
    li_profile_url: Type.String({
      ...
      description:
        "The LinkedIn profile URL to extract data from. Must be a valid LinkedIn URL starting with 'https://www.linkedin.com/sales/people/', 'https://www.linkedin.com/sales/lead/', 'https://www.linkedin.com/pub/' or 'https://www.linkedin.com/in/'",
      examples: ['https://www.linkedin.com/in/john-doe'],
    }),
    full_enrich: Type.Optional(
      Type.Boolean({
        default: false,
        description:
          'Extract experiences, skills and highlights. Set to true for comprehensive profile data.',
      })
    ),
  },
  { additionalProperties: false }
...
export const findPersonToolSchema = {
  description:
    "Find a person's LinkedIn profile by their name. Use this when you have someone's name and optionally their company, and need to find their LinkedIn profile URL. Perfect for starting lead research when you only have basic contact information.",
  parameters: FindPersonInputSchema,
};

export const searchPeopleToolSchema = {
  description:
    'Search for people using a Sales Navigator compliant query. Use this when you need to find potential leads, candidates, or contacts based on specific criteria like job title, company, location, or skills. Great for building prospect lists or finding experts in a particular field.',
  parameters: SearchPeopleInputSchema,
};

export const enrichPersonToolSchema = {
  description:
    'Extract detailed information from a LinkedIn profile. Use this when you need comprehensive data about a person including their work history, education, skills, and achievements. Perfect for lead research, candidate evaluation, or networking preparation.',
